...
ActiveRecord::Schema[7.0].define(version: 20_220_221_184_053) do
  ...
  create_table 'subcomments', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[commentable_type commentable_id], name: 'index_subcomments_on_commentable'
  ...
  create_table 'twit_tags', force: :cascade do |t|
    ...
    t.index %w[twit_id tag_id], name: 'index_twit_tags_on_twit_id_and_tag_id', unique: true
